...
export default function Navbar() {
  const active = ({ isActive }) => "px-1 " + (isActive ? "underline underline-offset-4 decoration-2" : "");
        ...
        <nav className="flex items-center gap-4">
          ...
          {authed ? (
            ...
            <>
              ...
              <button className="text-xs opacity-70 underline" onClick={check} title="Refresh login status">
                I’ve logged in
              </button>
            </>
          )}
