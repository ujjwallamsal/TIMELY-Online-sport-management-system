    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('ORGANIZER', 'Event Organizer'), ('COACH', 'Coach'), ('ATHLETE', 'Athlete'), ('SPECTATOR', 'Spectator')], default='SPECTATOR', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role_type', models.CharField(choices=[('ADMIN', 'Administrator'), ('ORGANIZER', 'Event Organizer'), ('COACH', 'Coach'), ('ATHLETE', 'Athlete'), ('SPECTATOR', 'Spectator')], max_length=20)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'status'], name='accounts_ro_user_id_a3bcdb_idx'),
        ),
        migrations.AddIndex(
            model_name='rolerequest',
            index=models.Index(fields=['requested_role', 'status'], name='accounts_ro_request_96a4d9_idx'),
        ),
        migrations.AddIndex(
            model_name='rolerequest',
            index=models.Index(fields=['status', 'created_at'], name='accounts_ro_status_bb4cbf_idx'),
        ),
        migrations.AddIndex(
            model_name='rolerequest',
            index=models.Index(fields=['created_at'], name='accounts_ro_created_3ff66a_idx'),
        ),
        migrations.AddIndex(
            model_name='userrole',
